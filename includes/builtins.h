...
/*   Updated: 2025/04/01 21:53:59 by shachowd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int								ft_unset(t_mshell *mshell, char **keys, int i,
									int index);
...
void							add_env_var(t_env **old_env, char *key,
									char *value);
void							process_with_sign(t_env **env, char *arg,
									char *sign);
int								update_env_state(t_mshell *mshell,
									char *current_pwd);
void							update_cd(t_env **env, const char *key,
									const char *set_path);
long long						ft_atoll(const char *str, long long number,
									long long check);
...
void							mshell_lvl_error(t_env **env, char *new_lvl,
									t_env *shlvl);
int								builtins_error(char *arg, char *err_msg,
									char *free_str);
